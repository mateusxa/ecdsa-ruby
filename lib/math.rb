        ...
        def self._jacobianMultiply(p, n, order, coeff, prime)
            ...
            if (n % 2) == 0
                return self._jacobianDouble(
                    self._jacobianMultiply(p, n / 2, order, coeff, prime), coeff, prime
                )
            end

            return self._jacobianAdd(
                self._jacobianDouble(self._jacobianMultiply(p, n / 2, order, coeff, prime), coeff, prime), p, coeff, prime
            )
