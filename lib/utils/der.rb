    ...
    module Utils
        ...
        class Der
            ...
            class DerFieldType
                ...
                attr_accessor :integer, :bitString, :octetString, :null, :object, 
                                :printableString, :utcTime, :sequence, :set, 
                                :oidContainer, :publicKeyPointContainer
